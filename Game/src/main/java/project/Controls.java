...
/**
 * Controls, manages key inputs from users to control the car.
 * Boolean variables are used to allow multiple key inputs at the same time.
 * Variables also remove input delay to allow better UX.
 *
...
public class Controls {
   ...
   */
  public Controls(Player player1, int[] player1controls) {
   ...
   */
  public Controls(Player player1, Player player2,
  ...
  /**
   * setUp, allows user to set a new keybind for up control.
   *
   * @param player current player
   * @param key new keybind
   */
  ...
  /**
   * setDown, allows user to set a new keybind for down control.
   *
   * @param player current player
   * @param key new keybind
   */
  ...
  /**
   * setLeft, allows user to set a new keybind for left control.
   *
   * @param player current player
   * @param key new keybind
   */
  ...
  /**
   * setRight, allows user to set a new keybind for right control.
   *
   * @param player current player
   * @param key new keybind
   */
