 ...
 */
public class HardTurnWall extends Wall {
  private float xCord;
  private float yCord;
  private float innerRadius;
  private float outerRadius;
  private int quadrant;
  private Color roadColor = new Color(0, 0, 0);
   ...
   */
  public HardTurnWall(float xCord, float yCord, float innerRadius, float width, Window window,
                      int quadrant) {
    this.xCord = xCord;
    this.yCord = yCord;
   ...
   */
  public boolean hasHitWall(PVector checkPosition) {
